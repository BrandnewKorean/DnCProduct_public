...
<link rel="stylesheet" type="text/css" href="resources/css/cat/location/hospitalmap.css?ver=<%=System.currentTimeMillis()%>">

</head>
<body>

<img src="resources/image/logoe.png" onclick="location.href='catmain'" width=15%>

<h1 style="color: green">동물병원 위치를 확인해보세요.</h1>
...
<h1 style="color: green; text-align: right;">from DnC</h1>
</body>
</html>