...
<body>
		...
		<div>
			<div>
				<div class="container-text" id="writebox">
					<p class="lead">이메일 주소와 ID를 입력해 주세요.</p>
					<p>
						*회원 가입시 입력하신 이메일 주소와 ID를 입력하시면,<br> 해당 이메일로 임시비밀번호를 보내드립니다.
					</p>
					<br>
					<div>
						<input type="email" name="email" id="email" placeholder="이메일 주소" value="" />
					...
					<div style="font-size: 10pt;">
						<ul style="list-style: none; padding: 0;">
							...
							<li style="display: none" id="mailCheck2">[이메일] : 해당 이메일 주소를 찾을 수 없습니다.</li>
							<li style="display: none" id="mailCheck3">[이메일] : 필수 입력입니다.</li>
						</ul>
					</div>
					<br>
					<button class="btn btn-primary btn-block" onclick="sendPassword()">비밀번호 찾기</button>
	...
	<script
		src="/resources/script/findpwcheck.js?ver=<%=System.currentTimeMillis()%>"></script>
</body>
</html>