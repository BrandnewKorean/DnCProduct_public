...
<link rel="stylesheet" type="text/css" href="resources/css/login/LoginSuccess.css?ver=<%= System.currentTimeMillis()%>">
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
<script type="text/javascript" src="resources/script/loginsuccess.js?ver=<%= System.currentTimeMillis()%>"></script>
</head>
<body>
	<div class=container>
		<div class=blue>
